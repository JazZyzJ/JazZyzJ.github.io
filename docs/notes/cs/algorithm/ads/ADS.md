...
总体的思路是将删除节点增黑，然后通过转移这个黑色到父亲节点，在进行黑高的平衡
...
删除节点是黑色，父亲也是黑色但是兄弟是红色，此时将兄弟染黑，父亲染红，但是这样会使黑高右移，因此需要进行左旋转
...
远侄子是黑色，近侄子是红色，此时将红色侄子与黑色父亲互换，会导致左侄子这条路的黑高多1，因此需要进行右旋转，然后这时远侄子就是红色了，进入Case 4
